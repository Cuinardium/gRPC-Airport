...
public class CounterRepositorySynchronizedTest {

    private CounterRepositorySynchronized counterRepositorySynchronized;

    @BeforeEach
    public void setUp() {
        counterRepositorySynchronized = new CounterRepositorySynchronized();
    }

    // ---- Sectors
    @Test
    public void testAddSector() throws AlreadyExistsException {
        counterRepositorySynchronized.addSector("D");
        counterRepositorySynchronized.addSector("C");

        Assertions.assertTrue(counterRepositorySynchronized.hasSector("D"));
        Assertions.assertTrue(counterRepositorySynchronized.hasSector("C"));

        List<Sector> sectors = counterRepositorySynchronized.getSectors();
        ...
        Optional<Sector> sector = counterRepositorySynchronized.getSector("D");
        Assertions.assertTrue(sector.isPresent());
        Assertions.assertEquals("D", sector.get().sectorName());

        sector = counterRepositorySynchronized.getSector("C");
        Assertions.assertTrue(sector.isPresent());
        Assertions.assertEquals("C", sector.get().sectorName());

        sector = counterRepositorySynchronized.getSector("A");
    ...
    public void testAddSectorAlreadyExists() throws AlreadyExistsException {
        ...
        Assertions.assertThrows(AlreadyExistsException.class, () -> counterRepositorySynchronized.addSector("D"));
    }
    ...
    public void testAddCounters() throws AlreadyExistsException {
        ...
        counterRepositorySynchronized.addCounters("D", 5);
        counterRepositorySynchronized.addCounters("C", 3);

        Assertions.assertTrue(counterRepositorySynchronized.hasCounters());

        Sector sector = counterRepositorySynchronized.getSector("D").get();
        ...
        sector = counterRepositorySynchronized.getSector("C").get();
        Assertions.assertEquals(1, sector.countersRangeList().size());
        ...
        counterRepositorySynchronized.addCounters("D", 3);
        sector = counterRepositorySynchronized.getSector("D").get();
        ...
        counterRepositorySynchronized.addCounters("D", 2);
        sector = counterRepositorySynchronized.getSector("D").get();
    ...
    public void testAddCountersNoSector() {
        Assertions.assertThrows(NoSuchElementException.class, () -> counterRepositorySynchronized.addCounters("D", 5));
    }
    ...
    public void testAssignCounterAssignment() throws AlreadyExistsException, FlightAlreadyCheckedInException, FlightAlreadyAssignedException, FlightAlreadyQueuedException {
        ...
        result = counterRepositorySynchronized.assignCounterAssignment("D", assignmentD1);
        ...
        for (String flight : flights) {
            Optional<CountersRange> countersRange = counterRepositorySynchronized.getFlightCounters(flight);
            ...
            Optional<Pair<CountersRange, String>> countersRangeAndSector = counterRepositorySynchronized.getFlightCountersAndSector(flight);
        ...
        result = counterRepositorySynchronized.assignCounterAssignment("C", assignmentC1);
        ...
        result = counterRepositorySynchronized.assignCounterAssignment("D", assignmentD2);
        ...
        // Test getFlightCounters and getFlightCountersAndSector
        Optional<CountersRange> countersRange = counterRepositorySynchronized.getFlightCounters("AA127");
        Assertions.assertTrue(countersRange.isPresent());
        Assertions.assertEquals(3, countersRange.get().range().from());
        Assertions.assertEquals(5, countersRange.get().range().to());

        Optional<Pair<CountersRange, String>> countersRangeAndSector = counterRepositorySynchronized.getFlightCountersAndSector("AA127");
        Assertions.assertTrue(countersRangeAndSector.isPresent());
        ...
        result = counterRepositorySynchronized.assignCounterAssignment("C", assignmentC2);
        ...
        // Test getFlightCounters and getFlightCountersAndSector
        countersRange = counterRepositorySynchronized.getFlightCounters("AA128");
        Assertions.assertTrue(countersRange.isPresent());
        Assertions.assertEquals(8, countersRange.get().range().from());
        Assertions.assertEquals(8, countersRange.get().range().to());

        countersRangeAndSector = counterRepositorySynchronized.getFlightCountersAndSector("AA128");
        Assertions.assertTrue(countersRangeAndSector.isPresent());
        ...
        result = counterRepositorySynchronized.assignCounterAssignment("D", assignmentD3);
        ...
        // Test getFlightCounters and getFlightCountersAndSector
        countersRange = counterRepositorySynchronized.getFlightCounters("AA129");
        Assertions.assertTrue(countersRange.isPresent());
        Assertions.assertEquals(9, countersRange.get().range().from());
        Assertions.assertEquals(11, countersRange.get().range().to());

        countersRangeAndSector = counterRepositorySynchronized.getFlightCountersAndSector("AA129");
        Assertions.assertTrue(countersRangeAndSector.isPresent());
